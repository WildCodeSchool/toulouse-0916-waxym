...
public class ActivityDataobject {
    ...
    public ActivityDataobject(int type, String label, String color) {
        this.label = label;
        this.type = type;
        this.color = color;
    }

    public ActivityDataobject(int type, String label, long clientId, long contractId, String color) {
        this.type = type;
        this.label = label;
